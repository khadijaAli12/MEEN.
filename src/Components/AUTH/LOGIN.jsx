    ...
    <div className="min-h-screen bg-gradient-to-b from-[#3E2723] via-[#4E342E] to-[#3E2723] flex items-center justify-center py-20">
      <div className="w-full max-w-md px-6">
        ...
        <div className="text-center mb-12">
          <span className="text-sm tracking-[0.3em] text-[#A1887F] font-light uppercase">Welcome Back</span>
          <h1 className="text-4xl sm:text-5xl font-light text-[#EFEBE9] mt-6 mb-4">Login to Continue</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-[#3E2723]/40 border border-[#6D4C41]/30 p-8 space-y-6">
          ...
          <p className="text-center text-sm text-[#BCAAA4] font-light mt-6">
            Don't have an account? <Link to="/signup" className="text-[#A1887F] hover:text-[#D7CCC8] transition-colors">Sign up</Link>
          </p>
        </form>
      </div>
    </div>
